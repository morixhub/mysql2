...
Mysql2::GEMSPEC = Gem::Specification.new do |s|
  ...
  s.authors = ['Brian Lopez', 'Aaron Stone', 'Moris Ravasio']
  s.license = "MIT"
  s.email = ['seniorlopez@gmail.com', 'aaron@serendipity.cx', 'moris.ravasio@aesys.com']
  s.extensions = ["ext/mysql2/extconf.rb"]
  s.homepage = 'https://github.com/morixhub/mysql2'
  ...
  s.metadata = {
    ...
    'source_code_uri'   => "https://github.com/morixhub/mysql2",
  }
